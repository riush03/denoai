export const receiptsSchema = {
    ...
    properties: {
      ...
      subtotal: {
        type: "number",
        dscription: "Subtotal of the receipt",
        minumum: 0,
      },
      tax: {
        type: "number",
        dscription: "Tax of the receipt",
        minumum: 0,
      },
      tip: {
        type: "number",
        dscription: "Tip of the receipt. If there is no tip, just put 0.",
        minumum: 0,
      },
      total: {
        type: "number",
        dscription: "Total amount of the receipt.",
        minumum: 0,
      },
    },
    required: [
